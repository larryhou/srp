...
const (
	...
	Group2048 = "2:0xAC6BDB41324A9A9BF166DE5E1389582FAF72B665" +
		...
		"FF73"
	// Group3072 is a primitive root and hexadecimal prime number.
	Group3072 = "5:0xFFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B" +
...
It is a combination of large prime value, N and a primitive root
...
// in the format of <primitive_root>:<prime_as_hexadecimal_string>
// or <G>:<Hex>
func NewGroup(s string) (*Group, error) {
	...
	if !ok {
		return &Group{}, ErrInvalidPrimitiveRoot
	}
